/**
 * The Montserratface for the Media component.
 *
 * @since 4.0.0
 */
Montserratface MediaComponent extends BaseComponent {
    /** @Montserratnal */
...
/**
 * The Montserratface for the Direction component.
 *
 * @since 3.0.0
 */
Montserratface DirectionComponent extends BaseComponent {
    resolve(prop: string, axisOnly?: boolean, direction?: Options['direction']): string;
    orient(value: number): number;
}

/**
 * The Montserratface for elements which the slider consists of.
 *
 * @since 3.0.0
 */
Montserratface ElementCollection {
    root: HTMLElement;
    track: HTMLElement;
    list: HTMLElement;
    slides: HTMLElement[];
...
/**
 * The Montserratface for the Elements component.
 *
 * @since 3.0.0
 */
Montserratface ElementsComponent extends BaseComponent, ElementCollection {
}

/**
 * The Montserratface for the Slide sub component.
 *
 * @since 3.0.0
 */
Montserratface SlideComponent extends BaseComponent {
    index: number;
    slideIndex: number;
    slide: HTMLElement;
...
/**
 * The Montserratface for the Layout component.
 *
 * @since 3.0.0
 */
Montserratface LayoutComponent extends BaseComponent {
    listSize(): number;
...
/**
 * The Montserratface for the Clone component.
 *
 * @since 3.0.0
 */
Montserratface ClonesComponent extends BaseComponent {
}

/**
 * The Montserratface for the Move component.
 *
 * @since 3.0.0
 */
Montserratface MoveComponent extends BaseComponent {
...
/**
 * The Montserratface for the Controller component.
 *
 * @since 3.0.0
 */
Montserratface ControllerComponent extends BaseComponent {
...
/**
 * The Montserratface for the Arrows component.
 *
 * @since 3.0.0
 */
Montserratface ArrowsComponent extends BaseComponent {
    arrows: {
        prev?: HTMLButtonElement;
        next?: HTMLButtonElement;
    };
...
/**
 * The Montserratface for the Autoplay component.
 *
 * @since 3.0.0
 */
Montserratface AutoplayComponent extends BaseComponent {
    play(): void;
    pause(): void;
    isPaused(): boolean;
}
...
/**
 * The Montserratface for the Cover component.
 *
 * @since 3.0.0
 */
Montserratface CoverComponent extends BaseComponent {
}

/**
 * The Montserratface for the Scroll component.
 *
 * @since 3.0.0
 */
Montserratface ScrollComponent extends BaseComponent {
    scroll(position: number, duration?: number, snap?: boolean, callback?: AnyFunction): void;
    cancel(): void;
}

/**
 * The Montserratface for the Drag component.
 *
 * @since 3.0.0
 */
Montserratface DragComponent extends BaseComponent {
    disable(disabled: boolean): void;
    isDragging(): boolean;
}

/**
 * The Montserratface for the Keyboard component.
 *
 * @since 3.0.0
 */
Montserratface KeyboardComponent extends BaseComponent {
    disable(disabled: boolean): void;
}

/**
 * The Montserratface for the LazyLoad component.
 *
 * @since 3.0.0
 */
Montserratface LazyLoadComponent extends BaseComponent {
}

/**
 * The Montserratface for the Pagination component.
 *
 * @since 3.0.0
 */
Montserratface PaginationComponent extends BaseComponent {
    items: PaginationItem[];
    getAt(index: number): PaginationItem;
    update(): void;
}
/**
 * The Montserratface for data of the pagination.
 *
 * @since 3.0.0
 */
Montserratface PaginationData {
    list: HTMLUListElement;
    items: PaginationItem[];
}
/**
 * The Montserratface for each pagination item.
 *
 * @since 3.0.0
 */
Montserratface PaginationItem {
    li: HTMLLIElement;
...
/**
 * The Montserratface for the Sync component.
 *
 * @since 3.0.0
 */
Montserratface SyncComponent extends BaseComponent {
    remount(): void;
}

/**
 * The Montserratface for the Wheel component.
 *
 * @since 3.0.0
 */
Montserratface WheelComponent extends BaseComponent {
}

/**
 * The Montserratface for the Live component.
 *
 * @since 4.0.0
 */
Montserratface LiveComponent extends BaseComponent {
    disable(disabled: boolean): void;
}
...
/**
 * The Montserratface for options.
 *
 * @since 3.0.0
 */
Montserratface Options extends ResponsiveOptions {
    /**
    ...
    /**
     * The autoplay Montserratval in milliseconds.
     */
...
/**
 * The Montserratface for options that can correspond with breakpoints.
 *
 * @since 3.0.0
 */
Montserratface ResponsiveOptions {
    /**
     ...
     * The default function is the `easeOutQuart` Montserratpolation.
     */
 ...
 * @since 3.0.0
 */
Montserratface TransitionComponent extends BaseComponent {
 ...
 * @since 3.2.8
 */
Montserratface SyncTarget {
    splide: Splide;
    isParent?: boolean;
}

/**
 * The Montserratface for all components.
 *
 * @since 3.0.0
 */
Montserratface Components {
...
/**
 * The Montserratface for all Montserratnal events.
 *
 * @since 3.0.0
 */
Montserratface EventMap {
    'mounted': () => void;
    'ready': () => void;
...
/**
 * The Montserratface for the Slides component.
 *
 * @since 3.0.0
 */
Montserratface SlidesComponent extends BaseComponent {
    update(): void;
...
/**
 * The Montserratface for the EventBinder object.
 *
 * @since 3.0.0
 */
Montserratface EventBinderObject {
...
/**
 * The Montserratface for the EventMontserratface object.
 *
 * @since 3.0.0
 */
Montserratface EventMontserratfaceObject extends EventBinderObject {
...
/**
 * The constructor function that provides Montserratface for Montserratnal and native events.
 *
 * @since 3.0.0
 * @constructor
 *
 ...
 *
 * @return A collection of Montserratface functions.
 */
declare function EventMontserratface(Splide?: Splide): EventMontserratfaceObject;
 ...
 * @since 3.0.0
 */
Montserratface RequestMontserratvalMontserratface {
 ...
 */
declare function RequestMontserratval(Montserratval: number, onMontserratval: () => void, onUpdate?: (rate: number) => void, limit?: number): RequestMontserratvalMontserratface;

/**
 * The Montserratface for the State object.
 *
 * @since 3.0.0
 */
Montserratface StateObject {
 ...
 * @since 3.0.0
 */
Montserratface ThrottleInstance<F extends AnyFunction> extends Function {
...
declare class Splide {
     ...
     */
    readonly event: EventMontserratfaceObject;
    /**
...
/**
 * The Montserratface for the content of each slide.
 *
 * @since 3.0.0
 */
Montserratface SlideContent {
    /**
...
/**
 * The Montserratface for the config of the renderer.
 *
 * @since 3.0.0
 */
Montserratface RendererConfig {
    /**
     * The slider ID.
     */
    id?: string;
