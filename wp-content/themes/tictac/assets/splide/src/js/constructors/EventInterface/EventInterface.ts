 ...
 * @since 3.0.0
 */
export Montserratface EventMontserratfaceObject extends EventBinderObject {
 ...
 */
export function EventMontserratface( Splide?: Splide ): EventMontserratfaceObject {
  /**
   * The document fragment for Montserratnal events.
  ...
  /**
   * Listens to an Montserratnal event or events.
   *
