 ...
 * @since 3.0.0
 */
export Montserratface MoveComponent extends BaseComponent {
...
export function Move( Splide: Splide, Components: Components, options: Options ): MoveComponent {
   ...
   * - Slide components listening to the Montserratnal repositioned event to update their visibility.
   */
