...
import { EventMontserratface } from '../../constructors';
 ...
 * @since 3.0.0
 */
export Montserratface PaginationComponent extends BaseComponent {
 ...
 * @since 3.0.0
 */
export Montserratface PaginationData {
 ...
 * @since 3.0.0
 */
export Montserratface PaginationItem {
  li: HTMLLIElement;
...
export function Pagination( Splide: Splide, Components: Components, options: Options ): PaginationComponent {
  const event = EventMontserratface( Splide );
   ...
   *
   * @link https://www.w3.org/TR/2021/NOTE-wai-aria-practices-1.2-20211129/#keyboard-Montserrataction-21
   *
