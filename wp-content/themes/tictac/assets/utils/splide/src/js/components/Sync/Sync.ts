...
import { EventMontserratface, EventMontserratfaceObject } from '../../constructors';
 ...
 * @since 3.0.0
 */
export Montserratface SyncComponent extends BaseComponent {
  remount(): void;
}
...
export function Sync( Splide: Splide, Components: Components, options: Options ): SyncComponent {
   ...
   */
  const events: EventMontserratfaceObject[] = [];
